...
"  --pidfd-in-fd FD      use specified unix socket FD to receive tasks pidfds\n"
"                        between pre-dump/dump iterations for pid reuse detection\n"
"  --pidfd-out-fd FD     use specified unix socket FD to send tasks pidfds\n"
"                        between pre-dump/dump iterations for pid reuse detection\n"
"\n"
